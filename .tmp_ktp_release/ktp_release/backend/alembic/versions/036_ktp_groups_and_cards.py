"""ktp_groups and ktp_cards tables

Revision ID: 036_ktp_groups_and_cards
Revises: 035_foreman_task_reports
...
def upgrade() -> None:
    ...
    # Уникальность: один group_key на батч+проект
    op.create_unique_constraint(
        "uq_ktp_groups_project_batch_key",
        "ktp_groups",
        ["project_id", "estimate_batch_id", "group_key"],
    )

    op.create_index("ix_ktp_groups_project_batch", "ktp_groups", ["project_id", "estimate_batch_id"])
    ...
    op.create_index("ix_ktp_cards_project_batch", "ktp_cards", ["project_id", "estimate_batch_id"])
