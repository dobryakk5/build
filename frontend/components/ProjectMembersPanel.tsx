...
const roles = {
  ...
  pm: { label: "Рук. проекта", color: "#0284c7", hint: "Редактирует план, смотрит отчеты" },
  foreman: { label: "Прораб", color: "#d97706", hint: "Подает ежедневные отчеты о прогрессе" },
  ...
  return (
    <section style={{ marginBottom: 20 }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 20 }}>
        <div>
          <div style={{ fontSize: 16, fontWeight: 700, margin: 0, color: "var(--text)" }}>Команда</div>
