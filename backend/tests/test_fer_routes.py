...
def test_build_fer_search_item_returns_ignore_flags():
    from app.api.routes import fer as fer_routes

    result = fer_routes._build_fer_search_item(
        {
            "table_id": 15,
    ...
    assert result["effective_ignored"] is True
    assert result["section"]["effective_ignored"] is True
