...
def test_runtime_dictionary_version_and_electrical_branch() -> None:
    ...
    assert taxonomy.dictionary_version() == "construction_work_dictionary_v6_4_8@1.7.8"
    assert taxonomy.DICTIONARY_SOURCE == "construction_work_dictionary_v6_4_8"
    assert taxonomy.PROMPT_VERSION == "estimate-v6.4.8"
