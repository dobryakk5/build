"""Seed work taxonomy rows from construction_work_dictionary v6.4.2."""
...
revision = "061_work_tax_v6_4_2_seed"
down_revision = "060_work_tax_v6_4_1_seed"
branch_labels = None
depends_on = None
...
def downgrade() -> None:
    raise NotImplementedError("Downgrade is intentionally not supported for taxonomy v6.4.2 seed")
