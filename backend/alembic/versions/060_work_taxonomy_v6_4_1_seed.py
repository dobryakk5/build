"""Seed work taxonomy rows from construction_work_dictionary v6.4.1."""
...
revision = "060_work_tax_v6_4_1_seed"
down_revision = "059_work_tax_v6_4_seed"
branch_labels = None
depends_on = None
...
def downgrade() -> None:
    raise NotImplementedError("Downgrade is intentionally not supported for taxonomy v6.4.1 seed")
