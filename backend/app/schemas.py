...
class EstimateRow(BaseModel):
    ...
    inherited_from_row_id: str | None = None
    stage_confidence: str | None = None
    work_type_confidence: str | None = None
    autofill_enabled: bool | None = None
    needs_review: bool = False
    review_reason: str | None = None
    stage_match_type: str | None = None
    stage_match_score_json: dict | None = None
    work_type_match_score_json: dict | None = None
    classification_score: float | None = None
    classification_confidence: str | None = None
    classification_needs_review: bool = False
    classification_source: str | None = None
    classification_candidates: list[dict] | None = None
    classification_matched_terms: dict | None = None
